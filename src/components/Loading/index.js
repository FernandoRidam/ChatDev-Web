...
export function Loading( props ) {
  ...
  return (
    <div className="loading" style={ stylesDiv }>
       <svg style={ stylesLoading } className="loading-lg" xmlns="http://www.w3.org/2000/svg" width="192" height="192" viewBox="0 0 192 192">
      ...
      <svg style={ stylesLoading } className="loading-md" xmlns="http://www.w3.org/2000/svg" width="192" height="192" viewBox="0 0 192 192">
